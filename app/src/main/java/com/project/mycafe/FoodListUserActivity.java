            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                dialog.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        if (item == 0) {
                            // update
                            Toast.makeText(FoodListUserActivity.this, "Detail is on developing progress", Toast.LENGTH_SHORT).show();

                        } else {
                            // delete
                            Toast.makeText(FoodListUserActivity.this, "Cart is on developing progress", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                dialog.show();
